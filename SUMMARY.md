...
* [Installing Polkadot JS wallet extension](testnet-staking-guide/installation-polkadot-js-wallet-extension.md)
* [Polkadot JS Wallet Setup](testnet-staking-guide/polkadot-js-wallet-setup.md)
* [Connecting Polkadot JS with Standard Protocol Network](testnet-staking-guide/connect-polkadot-js-with-standard-protocol-network.md)
* [Using Testnet Token Faucet](testnet-staking-guide/how-to-get-testnet-tokens.md)
* [Bonding OPT token](testnet-staking-guide/bonding-opt-token/README.md)
...
* [Prometheus](validator-run/prometheus.md)
* [Logging](validator-run/logging.md)
* [Alerting](validator-run/alerting.md)
